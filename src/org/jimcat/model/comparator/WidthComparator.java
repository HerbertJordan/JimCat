...
/**
 * The WidthComparator uses the width of two images to compare them.
 * 
 ...
 */
public class WidthComparator implements Comparator<Image> {
	...
	public int compare(Image o1, Image o2) {
		...
		if (o2 == null || o2.getMetadata() == null)
			return 1;
		Integer widthO1 = new Integer(o1.getMetadata().getWidth());
		Integer widthO2 = new Integer(o2.getMetadata().getWidth());
		return widthO1.compareTo(widthO2);
	}
